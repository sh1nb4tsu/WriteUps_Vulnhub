Lo primero que haremos sera ir a la pagina de Vulnhub y concretamente a la siguiente direccion para descargar la maquina "Earth":
...
Como no conocemos su extension, podemos probar con WFUZZ a ver si sacamos el tipo de dicha extension:
```
...
Usaremos una utilidad de rastreo de librerias llamada "ltrace" que nos indicara a cuales accede "reset_root" cuando lo ejecutamos.
